...
module Spring
  class << self
    # source://spring/3.1.1/lib/spring/configuration.rb#30
    def after_fork(&block); end

    # source://spring/3.1.1/lib/spring/configuration.rb#26
    def after_fork_callbacks; end

    # source://spring/3.1.1/lib/spring/configuration.rb#5
    def application_root; end

    # source://spring/3.1.1/lib/spring/configuration.rb#5
    def application_root=(_arg0); end

    # source://spring/3.1.1/lib/spring/configuration.rb#38
    def application_root_path; end

    # source://spring/3.1.1/lib/spring/configuration.rb#7
    def gemfile; end

    # source://spring/3.1.1/lib/spring/configuration.rb#17
    def gemfile_lock; end

    # source://spring/3.1.1/lib/spring/configuration.rb#51
    ...
    # source://spring/3.1.1/lib/spring/configuration.rb#34
    def verify_environment; end

    # source://spring/3.1.1/lib/spring/watcher.rb#27
    def watch(*items); end

    # source://spring/3.1.1/lib/spring/watcher.rb#6
    def watch_interval; end

    # source://spring/3.1.1/lib/spring/watcher.rb#6
    def watch_interval=(_arg0); end

    # source://spring/3.1.1/lib/spring/watcher.rb#8
    def watch_method; end

    # source://spring/3.1.1/lib/spring/watcher.rb#11
    def watch_method=(method); end

    # source://spring/3.1.1/lib/spring/watcher.rb#23
    def watcher; end

    # source://spring/3.1.1/lib/spring/watcher.rb#7
    def watcher=(_arg0); end

    private

    # source://spring/3.1.1/lib/spring/configuration.rb#57
