...
class Redis
  ...
  # source://redis//lib/redis.rb#153
  def _client; end

  # Disconnect the client as quickly and silently as possible.
  #
  # source://redis//lib/redis.rb#107
  def close; end
  ...
  # source://redis//lib/redis.rb#239
  def dup; end

  # source://redis//lib/redis.rb#231
  def id; end

  # source://redis//lib/redis.rb#235
  def inspect; end
  ...
  #
  # source://redis//lib/redis.rb#207
  def multi(&block); end

  # source://redis//lib/redis.rb#157
  ...
  # source://redis//lib/redis.rb#261
  def send_command(command, &block); end

  # source://redis//lib/redis.rb#257
  def synchronize; end
...
class Redis::Cluster::CommandErrorCollection < ::Redis::BaseError
  ...
  #
  # source://redis//lib/redis/errors.rb#67
  def initialize(errors, error_message = T.unsafe(nil)); end

  # Returns the value of attribute errors.
  #
  # source://redis//lib/redis/errors.rb#63
  def errors; end
end
...
#
# source://redis//lib/redis/errors.rb#81
class Redis::Cluster::CrossSlotPipeliningError < ::Redis::BaseError
  ...
  #
  # source://redis//lib/redis/errors.rb#82
...
class Redis::Cluster::Option
  ...
  # source://redis//lib/redis/cluster/option.rb#39
  def add_node(host, port); end

  # source://redis//lib/redis/cluster/option.rb#26
  def per_node_key; end

  # source://redis//lib/redis/cluster/option.rb#35
  def update_node(addrs); end

  # @return [Boolean]
  #
  # source://redis//lib/redis/cluster/option.rb#31
  def use_replica?; end
...
module Redis::Cluster::SlotLoader
  ...
  # source://redis//lib/redis/cluster/slot_loader.rb#34
...
module Redis::Commands::SortedSets
  ...
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#173
  ...
  # @return [nil] when no element could be popped and the timeout expired
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#194
  ...
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#600
  ...
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#709
  ...
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#725
  ...
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#83
  ...
  #   - when `:with_scores` is specified, an array with `[member, score]` pairs
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#623
  ...
  # @return [Integer] number of elements in the resulting sorted set
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#642
  ...
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#431
  ...
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#222
  ...
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#130
  ...
  # @return [Array<Array<String, Float>>] list of popped elements and scores
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#151
  ...
  #   - when `:with_scores` is specified, an array with `[member, score]` pairs
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#250
  ...
  #   - when `:with_scores` is specified, an array with `[member, score]` pairs
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#289
  ...
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#456
  ...
  #   - when `:with_scores` is specified, an array with `[member, score]` pairs
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#516
  ...
  # @see #zrange
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#331
  ...
  # @return [Integer]
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#382
  ...
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#104
  ...
  # @return [Integer] number of members that were removed
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#579
  ...
  # @see #zrange
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#366
  ...
  # @see #zrangebylex
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#478
  ...
  # @see #zrangebyscore
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#546
  ...
  # @return [Integer]
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#392
  ...
  #   members and scores
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#742
  ...
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#759
  ...
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#209
  ...
  #   - when `:with_scores` is specified, an array with `[member, score]` pairs
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#666
  ...
  # @return [Integer] number of elements in the resulting sorted set
  #
  # source://redis//lib/redis/commands/sorted_sets.rb#684
  def zunionstore(*args, **_arg1); end

  private

  # source://redis//lib/redis/commands/sorted_sets.rb#772
  def _zsets_operation(cmd, *keys, weights: T.unsafe(nil), aggregate: T.unsafe(nil), with_scores: T.unsafe(nil)); end

  # source://redis//lib/redis/commands/sorted_sets.rb#790
...
module Redis::Commands::Transactions
  ...
  # @see #exec
  #
  # source://redis//lib/redis/commands/transactions.rb#87
  def discard; end
  ...
  # @see #discard
  #
  # source://redis//lib/redis/commands/transactions.rb#75
  def exec; end
...
class Redis::Connection::Ruby
  ...
  # source://redis//lib/redis/connection/ruby.rb#412
  def format_bulk_reply(line); end

  # source://redis//lib/redis/connection/ruby.rb#400
  def format_error_reply(line); end

  # source://redis//lib/redis/connection/ruby.rb#408
  def format_integer_reply(line); end

  # source://redis//lib/redis/connection/ruby.rb#421
  def format_multi_bulk_reply(line); end

  # source://redis//lib/redis/connection/ruby.rb#389
  def format_reply(reply_type, line); end

  # source://redis//lib/redis/connection/ruby.rb#404
...
# source://redis//lib/redis/pipeline.rb#205
class Redis::DeprecatedMulti
  # @return [DeprecatedMulti] a new instance of DeprecatedMulti
  #
  # source://redis//lib/redis/pipeline.rb#206
  def initialize(pipeline); end

  # source://redis//lib/redis/pipeline.rb#211
  def __getobj__; end
end
...
class Redis::DeprecatedPipeline
  ...
  #
  # source://redis//lib/redis/pipeline.rb#191
  def initialize(pipeline); end

  # source://redis//lib/redis/pipeline.rb#196
  def __getobj__; end
end
...
class Redis::Pipeline
  ...
  # source://redis//lib/redis/pipeline.rb#100
  ...
  # @return [Boolean]
  #
  # source://redis//lib/redis/pipeline.rb#96
  def empty?; end

  # source://redis//lib/redis/pipeline.rb#137
  ...
  # source://redis//lib/redis/pipeline.rb#128
  def with_reconnect(val = T.unsafe(nil)); end
  ...
  class << self
    # source://redis//lib/redis/pipeline.rb#47
    def deprecation_warning(method, caller_locations); end
  end
end

# source://redis//lib/redis/pipeline.rb#149
class Redis::Pipeline::Multi < ::Redis::Pipeline
  # source://redis//lib/redis/pipeline.rb#180
  def commands; end

  # source://redis//lib/redis/pipeline.rb#150
  def finish(replies); end

  # source://redis//lib/redis/pipeline.rb#172
  def timeouts; end
end

# source://redis//lib/redis/pipeline.rb#41
