...
module Sidekiq
  class << self
    ...
    #
    # source://sidekiq//lib/sidekiq.rb#295
    ...
    # @yieldparam _self [Sidekiq] the object that the method was called on
    #
    # source://sidekiq//lib/sidekiq.rb#133
    ...
    # end
    #
    # source://sidekiq//lib/sidekiq.rb#242
    ...
    # source://sidekiq//lib/sidekiq.rb#213
    ...
    # @return [Boolean]
    #
    # source://sidekiq//lib/sidekiq.rb#286
    def ent?; end
    ...
    #
    # source://sidekiq//lib/sidekiq.rb#306
    ...
    # source://sidekiq//lib/sidekiq.rb#246
    ...
    # source://sidekiq//lib/sidekiq.rb#267
    def logger; end

    # source://sidekiq//lib/sidekiq.rb#271
    ...
    # @raise [ArgumentError]
    #
    # source://sidekiq//lib/sidekiq.rb#318
    ...
    # @return [Boolean]
    #
    # source://sidekiq//lib/sidekiq.rb#282
    def pro?; end
    ...
    # source://sidekiq//lib/sidekiq.rb#173
    def redis_info; end
    ...
    # @return [Boolean]
    #
    # source://sidekiq//lib/sidekiq.rb#147
    def server?; end

    # @yield [@server_chain]
    #
    # source://sidekiq//lib/sidekiq.rb#207
    def server_middleware; end

    # source://sidekiq//lib/sidekiq.rb#324
...
# end
#
# source://sidekiq//lib/sidekiq/middleware/chain.rb#72
module Sidekiq::Middleware; end

# source://sidekiq//lib/sidekiq/middleware/chain.rb#73
class Sidekiq::Middleware::Chain
  ...
  # source://sidekiq//lib/sidekiq/middleware/chain.rb#134
  def clear; end
  ...
  # @return [Boolean]
  #
  # source://sidekiq//lib/sidekiq/middleware/chain.rb#126
  def empty?; end

  # source://sidekiq//lib/sidekiq/middleware/chain.rb#90
  def entries; end
  ...
  # source://sidekiq//lib/sidekiq/middleware/chain.rb#115
  def insert_after(oldklass, newklass, *args); end

  # source://sidekiq//lib/sidekiq/middleware/chain.rb#108
  def insert_before(oldklass, newklass, *args); end

  # source://sidekiq//lib/sidekiq/middleware/chain.rb#138
  def invoke(*args); end

  # source://sidekiq//lib/sidekiq/middleware/chain.rb#103
  def prepend(klass, *args); end

  # source://sidekiq//lib/sidekiq/middleware/chain.rb#94
  def remove(klass); end

  # source://sidekiq//lib/sidekiq/middleware/chain.rb#130
  def retrieve; end

  private

  # source://sidekiq//lib/sidekiq/middleware/chain.rb#76
...
class Sidekiq::Middleware::Entry
  ...
  #
  # source://sidekiq//lib/sidekiq/middleware/chain.rb#158
  def initialize(config, klass, *args); end

  # Returns the value of attribute klass.
  #
  # source://sidekiq//lib/sidekiq/middleware/chain.rb#156
  def klass; end

  # source://sidekiq//lib/sidekiq/middleware/chain.rb#164
  def make_new; end
end
...
#
# source://sidekiq//lib/sidekiq.rb#334
